...
for (i in nrow(gundeaths_cut)) {
    ...
    if (gundeaths_cut$State_Name[i] %in% merged_guns$state) {
        merged_guns$deaths[gundeaths_cut$State_Name[i]] <- merged_guns$deaths[gundeaths_cut$State_Name[i]] + gundeaths_cut$Deaths[i]
        merged_guns$population[gundeaths_cut$State_Name[i]] <- merged_guns$population[gundeaths_cut$State_Name[i]] + gundeaths_cut$Population
    }
}
